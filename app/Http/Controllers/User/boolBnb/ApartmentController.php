...
namespace App\Http\Controllers\User\boolBnb;

use App\Http\Controllers\Controller;
use App\Models\boolBnb\Apartment;
use App\Models\boolBnb\Message;
use App\Models\boolBnb\Photo;
...
class ApartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("user.boolBnb.apartments.index", compact("apartments"));
    }
    ...
    public function create()
    {
        ...
        return view("user.boolBnb.apartments.create", compact("apartment",'services'));
    }
    ...
    public function show($id)
    {
        ...
        if (Auth::id() != $apartment->user_id) abort(401);
            ...
            return view("user.boolBnb.apartments.show", compact("apartment"));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if (Auth::id() != $apartment->user_id) abort(401);
            ...
            return view("user.boolBnb.apartments.edit", compact("apartment", "services"));
        }
    }
    ...
    public function messagesIndex($id) {
        ...
        return view("user.boolBnb.messages.index", compact("messages"));
    ...
    public function showMessage($id) {
        ...
        return view("user.boolBnb.messages.show", compact("message"));
    }
    ...
    public function goToSponsorshipsPage($id)
    {
        ...
        return view("user.boolBnb.apartments.assignSponsor", compact('apartment','sponsorships'));
    }

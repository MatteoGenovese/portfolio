<template>
    <div>
        ...
        <div id="propertyOverview" class="container brand-ft-1 p-0">
            <HeaderComponent />
            <ContactWarnComponent v-if="warnMessage" class="mt-5"/>
...
import ContactForm from "../../components/boolBnb/ContactForm.vue"
import ContactWarnComponent from "../../components/boolBnb/ContactWarnComponent.vue";
import HeaderComponent from "../../components/boolBnb/HeaderComponent.vue";
...
export default {
    ...
    methods: {
        ...
        selectApartmentBySponsorship(apartment) {
            console.log('check',apartment);
            if(apartment.sponsorships == 'undefined')
            {
